...
class RmanTasks():
    ...
    '''
    backup = '8003585500000052554e207b0a202020204241434b555020415320434f4d50524553534544204241434b555053455420444154414241534520504c555320415243484956454c4f472044454c45544520414c4c20494e5055543b0a7d71002e'
    obsolete = '8003583f00000052554e207b0a2020202044454c455445204e4f50524f4d5054204f42534f4c455445205245434f564552592057494e444f57204f46203320444159533b0a7d71002e'
    delete = '8003584100000052554e207b0a2020202044454c455445204e4f50524f4d5054204241434b555020434f4d504c45544544204245464f5245202773797364617465202d34273b0a7d71002e'
    backup_and_delete= ''
    ...
    def send(self,url,files=None):
        ...
        for filename in array:
            with open(filename,'r') as stream:
                stream_text = stream.read()
                if len(big_stream) and (len(big_stream + stream_text)) > 1800:
                    send(url, title='RmanApi - report - {}'.format(self.date), msg=big_stream)
                    big_stream = ''
                big_stream += stream_text
                big_stream += '\n\n'
